...
type
  ...
  Option* = enum
    ...
    OPT_ACCEPT_ENCODING = 10000 + 102, OPT_PRIVATE = 10000 + 103,
...
proc multi_poll*(multi_handle: PM, extra_fds: Waitfd, extra_nfds: uint32, 
                 timeout_ms: int32, numfds: var int32): Mcode{.
